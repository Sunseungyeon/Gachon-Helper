...
if (isset($_POST['title']) && isset($_POST['helpy_stu_id'])) {

    // receiving the post params
    $helpy_stu_id = $_POST['helpy_stu_id'];
    $title = $_POST['title'];
    $sql = "SELECT helper_name, helper_stu_id, helper_category, helper_tickets, helper_phone, title, created_at FROM connecter WHERE helpy_stu_id = '".$helpy_stu_id."' AND title = '".$title."'";
